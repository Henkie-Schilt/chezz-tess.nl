...
export const WEBSHOP_BLACK_COLOR = "#000000"; 
...
export const CHECKOUT_ERROR_TOAST =
    "Helaas is er iets misgegaan bij het bestellen. Neem contact op met ons door een berichtje te sturen of stuur een screenshot van je winkelwagen naar chezz.tess@gmail.com";
...
export const CONTACT_TEXT = (
    <span>
        Heb je een vraag? Vul het onderstaande formulier in en ik zal zo spoedig mogelijk contact met je opnemen!
